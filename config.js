...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("50948134767")
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'FEDLY BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Fedly' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'Fedly' : process.env.PACK_INFO.split(";")[0],
